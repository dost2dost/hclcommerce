...
declare const $referenceCount: unique symbol;
declare const $updateVisibility: unique symbol;
declare const $visible: unique symbol;
declare const $onSlotchange: unique symbol;
declare const $slotchangeHandler: unique symbol;
/**
...
export declare class Hotspot extends CSS2DObject {
    ...
    protected [$updateVisibility]({ notify }: {
        notify: boolean;
    }): void;
