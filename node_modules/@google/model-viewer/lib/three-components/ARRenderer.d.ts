import { EventDispatcher, PerspectiveCamera, Vector3, WebGLRenderer } from 'three';
...
declare const $selectStartHandler: unique symbol;
declare const $onSelectStart: unique symbol;
declare const $selectEndHandler: unique symbol;
...
export declare class ARRenderer extends EventDispatcher {
    ...
    [$onSelectEnd](_event: XRInputSourceEvent): void;
