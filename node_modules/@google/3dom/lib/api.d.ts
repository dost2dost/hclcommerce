 ...
 */
export declare type ThreeDOMCapability = 'messaging' | 'material-properties' | 'fetch';
/**
...
export declare interface ThreeDOMGlobalScope extends Worker {
    ...
    addEventListener<K extends keyof ThreeDOMEventMap>(type: K, listener: (this: ThreeDOMGlobalScope, event: ThreeDOMEventMap[K]) => unknown, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof ThreeDOMEventMap>(type: K, listener: (this: ThreeDOMGlobalScope, ev: ThreeDOMEventMap[K]) => unknown, options?: boolean | EventListenerOptions): void;
